			...
			<div class="konten_dalem khusus3 mt-5">
					...
					<hr style="margin-top: -2px;">
                        ...
                        <div class="input-group mb-3">
                            <a href="" onclick="this.href='/dashboard/laporan/cetak/'+ document.getElementById('mitra_id').value + '/' + document.getElementById('mulai').value + '/' + document.getElementById('selesai').value "
