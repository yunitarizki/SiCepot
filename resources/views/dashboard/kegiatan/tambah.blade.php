            ...
            <div class="container">
                <form action="/dashboard/kegiatan" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-75">
                            <input type="text" id="name" name="name" required placeholder="Masukan Kegiatan" value="{{ old('name') }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-75">
                            <input type="text" id="harga" name="harga" required placeholder="Masukan Harga satuan tanpa titik" value="{{ old('harga') }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-25">
                        ...
                        <div class="col-75">
                            <input type="text" id="ba" name="ba" required placeholder="Masukan BA" value="{{ old('ba') }}">
                        </div>
                    </div>
                    <br>
                    <div class="row">
